...
def test_api_cancel_order_invalid_state():
    mock_order = MagicMock()
    mock_order.cancel_order.side_effect = ValueError("Cannot cancel your order")
